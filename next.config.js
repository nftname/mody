...
const nextConfig = {
  ...
  async headers() {
    const cspHeader = `
      ...
      img-src 'self' blob: data: https://gateway.pinata.cloud https://ipfs.io https://cloudflare-ipfs.com https://raw.githubusercontent.com https://cryptologos.cc https://cdn-icons-png.flaticon.com https://api.qrserver.com ​https://imagedelivery.net https://explorer-api.walletconnect.com;
