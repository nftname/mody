...
export default function LegalModal() {
  ...
  useEffect(() => {
    const checkTerms = () => {
        // قمنا بتحديث النسخة إلى v9 ليظهر للمستخدمين الاتفاقية الجديدة المكونة من 14 بند
  ...
  return (
    <div style={{
      ...
      <style jsx global>{`
        ...
        .legal-ul li { margin-bottom: 4px; list-style-type: disc; color: #B0B0B0; font-weight: 300; }
      `}</style>
      ...
      <div style={{
        ...
        <div className="p-3 border-bottom" style={{ borderColor: '#333' }}>
          <h5 className="fw-bold m-0 ps-2" style={{ fontFamily: 'sans-serif', fontSize: '20px', color: '#E0E0E0' }}>
        ...
        <div className="legal-scroll p-4" style={{ 
          ...
          fontSize: '11.5px', 
          fontWeight: '300',
          color: '#B0B0B0', // لون رمادي مريح للعين
          lineHeight: '1.6', 
          textAlign: 'left'
        }}>
            <p className="mb-3">
              <strong style={{ color: '#E0E0E0', fontWeight: '600' }}>IMPORTANT NOTICE:</strong> By accessing, browsing, connecting a wallet to, minting through, listing on, interacting with, or otherwise using the NFT Name Market (NNM) interface (the &quot;Site&quot;) and protocol, you acknowledge that you have read, understood, and fully agree to be legally bound by this User Agreement (&quot;Agreement&quot;). If you do not agree to any portion of these Terms, you must immediately discontinue all access to the Site and Protocol.
            </p>

            <div style={{ height: '1px', backgroundColor: '#333', margin: '15px 0' }}></div>

            {/* SECTION I */}
            <h6 className="fw-bold mt-3 mb-2" style={{ fontSize: '13px', fontWeight: '600', color: '#E0E0E0' }}>I. TERMS OF SERVICE & LIABILITY</h6>

            <p className="mb-1" style={{ fontWeight: '500', color: '#E0E0E0' }}>1. ELIGIBILITY & AGE REQUIREMENTS</p>
            <p className="mb-3">
              By using the NNM Protocol you represent, warrant, and covenant that you are at least <strong style={{ fontWeight: '500', color: '#E0E0E0' }}>18 years old</strong> (or of legal majority where you reside), that you possess the full legal capacity and authority to enter into this Agreement, and that your use of the Protocol will comply with all applicable laws and regulations.
            </p>

            <p className="mb-1" style={{ fontWeight: '500', color: '#E0E0E0' }}>2. PROTOCOL NATURE &mdash; INTERFACE-ONLY</p>
            <p className="mb-1">NNM is strictly a <strong style={{ fontWeight: '500', color: '#E0E0E0' }}>visual interface layer</strong>. It is not an exchange, escrow, broker, custodian, wallet provider, financial institution, or regulated marketplace.</p>
            ...
            <p className="mb-1" style={{ fontWeight: '500', color: '#E0E0E0' }}>3. JURISDICTION-NEUTRAL OPERATION</p>
            <p className="mb-3">
            ...
            <p className="mb-1" style={{ fontWeight: '500', color: '#E0E0E0' }}>4. NO FINANCIAL, LEGAL, OR TAX ADVICE</p>
            <p className="mb-3">
            ...
            <p className="mb-1" style={{ fontWeight: '500', color: '#E0E0E0' }}>5. LIMITATION OF LIABILITY &mdash; &quot;AS IS&quot;</p>
            <p className="mb-3">
              To the fullest extent permitted by law, <strong style={{ fontWeight: '500', color: '#E0E0E0' }}>NNM expressly disclaims all warranties</strong>. The Service is provided &quot;AS IS.&quot; NNM shall not be liable for any damages, lost profits, smart-contract vulnerabilities, gas fee losses, or unauthorized access. NNM&apos;s liability is limited to the maximum extent permitted by law.
            </p>

            <p className="mb-1" style={{ fontWeight: '500', color: '#E0E0E0' }}>6. USER RESPONSIBILITY & INDEMNIFICATION</p>
            ...
            <p className="mb-1" style={{ fontWeight: '500', color: '#E0E0E0' }}>7. ASSET CLASSIFICATION</p>
            <p className="mb-1">NFTs are classified as <strong style={{ fontWeight: '500', color: '#E0E0E0' }}>&quot;Visual Identity Assets&quot;</strong>.</p>
            <ul className="legal-ul">
            ...
            <p className="mb-1" style={{ fontWeight: '500', color: '#E0E0E0' }}>8. PROHIBITED ACTIVITIES</p>
            ...
            <p className="mb-1" style={{ fontWeight: '500', color: '#E0E0E0' }}>9. INITIAL MARKET TESTING & OPERATIONAL WALLETS</p>
            <p className="mb-3">
            ...
            <p className="mb-1" style={{ fontWeight: '500', color: '#E0E0E0' }}>10. CONVICTION RANK & POINTS SYSTEM</p>
            <p className="mb-3">
            ...
            <p className="mb-1" style={{ fontWeight: '500', color: '#E0E0E0' }}>11. GOVERNING LAW & ARBITRATION</p>
            <p className="mb-3">
              All disputes shall be resolved by binding individual arbitration. Class-actions are waived. Governed by the laws of <strong style={{ fontWeight: '500', color: '#E0E0E0' }}>Singapore</strong>.
            </p>

            <div style={{ height: '1px', backgroundColor: '#333', margin: '15px 0' }}></div>

            {/* SECTION II */}
            <h6 className="fw-bold mt-3 mb-2" style={{ fontSize: '13px', fontWeight: '600', color: '#E0E0E0' }}>II. PRIVACY POLICY</h6>

            <p className="mb-1" style={{ fontWeight: '500', color: '#E0E0E0' }}>12. MAXIMUM PRIVACY / DATA POLICY</p>
            ...
            {/* SECTION III */}
            <h6 className="fw-bold mt-3 mb-2" style={{ fontSize: '13px', fontWeight: '600', color: '#E0E0E0' }}>III. INTELLECTUAL PROPERTY</h6>

            <p className="mb-1" style={{ fontWeight: '500', color: '#E0E0E0' }}>13. NGX NFT INDEX OWNERSHIP & DISCLAIMER</p>
            <p className="mb-3">
            ...
            <p className="mb-1" style={{ fontWeight: '500', color: '#E0E0E0' }}>14. TAKEDOWN MECHANISM</p>
        ...
        <div className="p-3 border-top d-flex justify-content-end gap-3" style={{ borderColor: '#333', backgroundColor: '#252525', borderBottomLeftRadius: '12px', borderBottomRightRadius: '12px' }}>
            <button 
                ...
                onMouseOver={(e) => { e.currentTarget.style.borderColor = '#888'; e.currentTarget.style.color = '#E0E0E0'; }}
