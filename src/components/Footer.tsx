...
const Footer = () => {
  // لون موحد للروابط والنصوص لضمان التناسق التام
    ...
    <footer className="desktop-only-footer" style={{ backgroundColor: '#0B0E11', borderTop: '1px solid rgba(255, 255, 255, 0.08)', padding: '40px 0 20px', marginTop: 'auto' }}>
        <div className="container">
            <div className="row g-4">
                ...
                {/* SECTION 1: COMMUNITY (MOVED TO LEFT) + ADDED FB & TELEGRAM */}
                <div className="col-6 col-md-3 pe-md-4" style={{ borderRight: '1px solid rgba(255, 255, 255, 0.05)' }}>
        ...
        <style jsx>{`
            ...
            .footer-social-row { 
                ...
                color: ${linkColor}; /* Unified Color (0.5 opacity) */
            ...
            /* General Links Style - Matching Socials Exactly */
            .footer-link-item { 
                text-decoration: none; 
                color: ${linkColor}; /* Unified Color (0.5 opacity) */
                font-size: ${fontSize}; 
