          ...
          <div className="d-flex flex-column flex-lg-row align-items-start w-100" style={{ paddingTop: '4px' }}>
            ...
            <div className="d-none d-lg-flex align-items-center justify-content-end gap-2" style={{ marginTop: '5px' }}> 
                ...
                <button onClick={handlePortfolioClick} className="btn" style={portfolioBtnStyle} title="Go to Dashboard">
                    <ChicProfileIcon size={26} color="#FCD535" />
                </button>
          ...
          <div className="drawer-header d-flex flex-column align-items-center pt-5 pb-2 w-100 mt-3 position-relative" style={{borderBottom: '1px solid #333'}}>
              ...
              <div className="d-flex align-items-center gap-3 mb-3">
                <svg width="34" height="34" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g>
                        <path d="M256 20 L356 120 L256 220 L156 120 Z" fill="url(#drawerGold)" />
                        <path d="M156 120 L256 220 L256 240 L156 140 Z" fill="#9E7C0C" />
                        <path d="M256 292 L356 392 L256 492 L156 392 Z" fill="url(#drawerGold)" />
                        <path d="M120 156 L220 256 L120 356 L20 256 Z" fill="url(#drawerGold)" />
