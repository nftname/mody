...
const Navbar = () => {
  ...
  const goldGradient = 'linear-gradient(135deg, #D4AF37 0%, #C5A028 50%, #997B19 100%)';
  const navbarBgColor = '#0b0e11';

  const customDisconnectStyle = {
    background: goldGradient,
    color: '#000',
    border: '1px solid #997B19',
  ...
  const ChicProfileIcon = ({ size = 24, color = "#D4AF37" }) => (
    ...
    <nav className="navbar navbar-expand-lg fixed-top py-0" 
      ...
      <div className="container-fluid px-2 h-100 align-items-center d-flex flex-nowrap">
        ...
        <div className="d-flex align-items-center d-lg-none me-auto gap-2">
            <button className="navbar-toggler border-0 p-0 shadow-none" type="button" onClick={toggleDrawer} style={{ width: '24px' }}>
                <i className="bi bi-list" style={{ fontSize: '26px', color: '#D4AF37' }}></i>
            </button>
            ...
            <Link href="/" className="navbar-brand d-flex align-items-center gap-2 m-0 p-0" style={{ textDecoration: 'none' }}> 
              <svg width="28" height="28" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg" style={{flexShrink: 0}}>
                <defs>
                  <linearGradient id="blockGoldMobile" x1="0%" y1="0%" x2="100%" y2="100%">
                    ...
                    <stop offset="100%" stopColor="#997B19" />
                  </linearGradient>
                </defs>
                <g>
                    <path d="M256 20 L356 120 L256 220 L156 120 Z" fill="url(#blockGoldMobile)" />
                    <path d="M156 120 L256 220 L256 240 L156 140 Z" fill="#7A6214" />
              ...
              <span style={{ fontFamily: 'sans-serif', fontWeight: '800', fontSize: '21px', color: '#D4AF37', letterSpacing: '1px', lineHeight: '1', marginTop: '1px' }}>NNM</span>
            </Link>
        </div>
            ...
            <Link href="/" className="navbar-brand d-flex align-items-center gap-2 m-0 p-0" style={{ textDecoration: 'none' }}> 
              <svg width="29" height="29" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg" style={{flexShrink: 0}}>
                ...
                <g filter="url(#innerEtch)">
                    ...
                    <path d="M356 392 L256 492 L256 472 L356 372 Z" fill="#453609" opacity="0.5" />
              ...
              <span style={{ fontFamily: 'sans-serif', fontWeight: '800', fontSize: '20px', background: 'linear-gradient(135deg, #E6C200 0%, #D4AF37 50%, #997B19 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', letterSpacing: '1px', lineHeight: '1', marginTop: '1px' }}>NNM</span>
            </Link>
        </div>
        ...
        <div className="d-flex d-lg-none align-items-center ms-auto" style={{ gap: '8px', overflow: 'visible', paddingRight: '0px' }}>
            <button className="btn p-1 border-0" onClick={() => setIsMobileSearchOpen(!isMobileSearchOpen)} style={{ width: '28px' }}>
                <i className="bi bi-search" style={{ fontSize: '16px', color: '#D4AF37' }}></i>
            </button>
            ...
            <button className="btn p-0 d-flex align-items-center justify-content-center" onClick={handlePortfolioClick}
                ...
                <ChicProfileIcon size={24} color="#D4AF37" />
            </button>
            ...
            <div className="d-none d-lg-flex align-items-center justify-content-end gap-2" style={{ marginTop: '5px' }}> 
                <form onSubmit={handleSearch} className="position-relative" style={{ width: '280px', height: '23px', flexShrink: 0 }}>
                   <input type="text" className="form-control search-input-custom text-white shadow-none" placeholder="Search..." 
                        ...
                        style={{ borderRadius: '6px', fontSize:'13px', height: '100%', paddingLeft: '30px', border: '1px solid rgba(212, 175, 55, 0.5)', boxShadow: '0 0 5px rgba(212, 175, 55, 0.1)', caretColor: '#D4AF37' }} 
                   />
                   <button type="submit" className="btn p-0 position-absolute" style={{top: '50%', transform: 'translateY(-50%)', left: '10px', border:'none', background:'transparent'}}>
                        <i className="bi bi-search text-secondary" style={{fontSize: '12px', color: '#D4AF37 !important'}}></i>
                   </button>
                </form>
                
                <button onClick={handlePortfolioClick} className="btn" style={portfolioBtnStyle} title="Go to Dashboard">
                    <ChicProfileIcon size={26} color="#D4AF37" />
                </button>
      ...
      >
          <div style={{
             ...
             <div style={{ width: '2px', height: '20px', backgroundColor: '#444', borderRadius: '1px' }}></div>
             <div style={{ width: '2px', height: '20px', backgroundColor: '#444', borderRadius: '1px' }}></div>
             <div style={{ width: '2px', height: '20px', backgroundColor: '#444', borderRadius: '1px' }}></div>
          </div>
          ...
          <div className="drawer-header d-flex flex-column align-items-start px-4 pt-5 pb-3 w-100 mt-4 position-relative" style={{borderBottom: '1px solid #1a1a1a'}}>
              <button onClick={closeDrawer} className="btn position-absolute top-0 end-0 m-3 text-secondary p-2">
                  <i className="bi bi-x-lg" style={{ fontSize: '22px', color: '#666' }}></i>
              </button>

              <div className="d-flex align-items-center gap-3 mb-2">
                <svg width="40" height="40" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                      <linearGradient id="drawerGoldMatte" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stopColor="#C2A03D" />
                        <stop offset="50%" stopColor="#8F7224" />
                        <stop offset="100%" stopColor="#5E4B18" />
                      </linearGradient>
                    </defs>
                    <g>
                        <path d="M256 20 L356 120 L256 220 L156 120 Z" fill="url(#drawerGoldMatte)" />
                        <path d="M156 120 L256 220 L256 240 L156 140 Z" fill="#524115" />
                        <path d="M256 292 L356 392 L256 492 L156 392 Z" fill="url(#drawerGoldMatte)" />
                        <path d="M120 156 L220 256 L120 356 L20 256 Z" fill="url(#drawerGoldMatte)" />
                        <path d="M392 156 L492 256 L392 356 L292 256 Z" fill="url(#drawerGoldMatte)" />
                    </g>
                </svg>
                <span style={{ fontFamily: 'sans-serif', fontWeight: '800', fontSize: '26px', color: '#C2A03D', letterSpacing: '1px' }}>NNM</span>
              </div>
          </div>
          ...
          <div className="drawer-content px-4 py-3 d-flex flex-column h-100" style={{ overflowY: 'auto' }}>
              ...
              <div className="drawer-footer pt-3 border-top border-secondary border-opacity-10 mt-2 d-flex align-items-center w-100">
                  <div className="d-flex justify-content-between align-items-center" style={{ width: '80%', paddingRight: '15px' }}>
                      <i className="bi bi-twitter-x" style={{ fontSize: '20px', color: '#8F7224' }}></i>
                      <i className="bi bi-discord" style={{ fontSize: '20px', color: '#8F7224' }}></i>
                      <i className="bi bi-instagram" style={{ fontSize: '20px', color: '#8F7224' }}></i>
                      <i className="bi bi-telegram" style={{ fontSize: '20px', color: '#8F7224' }}></i>
                      <i className="bi bi-youtube" style={{ fontSize: '20px', color: '#8F7224' }}></i>
                  </div>
                  ...
                  <div className="d-flex justify-content-center align-items-center" style={{ width: '20%', borderLeft: '1px solid #222' }}>
                      <Link href="/contact" onClick={closeDrawer}>
                        <i className="bi bi-envelope-fill" style={{ fontSize: '22px', color: '#8F7224' }}></i>
                      </Link>
                  </div>
              </div>
          </div>
      ...
      {isMobileSearchOpen && (
        <div className="d-lg-none position-absolute start-0 w-100" style={{ top: '60px', zIndex: 1049, backgroundColor: navbarBgColor, padding: '12px 15px', borderBottom: '1px solid rgba(212, 175, 55, 0.3)' }}>
            <form onSubmit={handleSearch} className="position-relative">
                <input ref={mobileSearchInputRef} type="text" className="form-control bg-dark text-white shadow-none" placeholder="Search collections..." 
                    value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}
                    style={{ borderRadius: '4px', fontSize: '14px', height: '42px', paddingLeft: '38px', paddingRight: '35px', border: '1px solid #D4AF37', caretColor: '#D4AF37' }} 
                />
      ...
      <style jsx global>{`
        ...
        .desktop-nav-link:hover, .desktop-nav-link.active { color: #D4AF37 !important; }
        .text-gold { color: #D4AF37 !important; }
        .dropdown-item:hover, .dropdown-item:focus { background-color: #2b3139 !important; color: #D4AF37 !important; }
        .nav-link:focus, .nav-link:active { color: #D4AF37 !important; outline: none !important; box-shadow: none !important; }
        .navbar-toggler:focus { box-shadow: none !important; }
        .search-input-custom { background-color: #161b22 !important; transition: background-color 0.3s ease; }
        .search-input-custom:focus { background-color: ${navbarBgColor} !important; border-color: #D4AF37 !important; }
