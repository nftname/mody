...
const Navbar = () => {
                  ...
                  return (
                    <div onClick={openAccountModal} style={{...customConnectStyle, fontSize}}>
                        <div style={{
                            ...
                            background: '#27ae60', boxShadow: '0 0 8px rgba(39, 174, 96, 0.6)', flexShrink: 0
                        }}></div>
  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg fixed-top py-0" 
                ...
                <ul className="navbar-nav mb-2 mb-lg-0 gap-2 gap-xl-3 align-items-center">
                    ...
                    <li className="nav-item dropdown" style={{ zIndex: 1055 }}
                      ...
                      <ul className={`dropdown-menu shadow-lg py-1 ${isInsightsOpen ? 'show' : ''}`} 
                          style={{ backgroundColor: solidDarkBg, border: `1px solid ${subtleBorder}`, minWidth: '160px', marginTop: '10px' }}>
          ...
          <div className="drawer-content px-4 py-3 d-flex flex-column h-100" style={{ overflowY: 'auto' }}>
              ...
              <div className="drawer-footer pt-3 border-top border-secondary border-opacity-10 mt-2 d-flex align-items-center w-100 mb-4">
                  <div className="d-flex justify-content-between align-items-center w-100 px-2">
                      <i className="bi bi-twitter-x" style={{ fontSize: '18px', color: '#888' }}></i>
                      <i className="bi bi-discord" style={{ fontSize: '18px', color: '#888' }}></i>
                      <i className="bi bi-instagram" style={{ fontSize: '18px', color: '#888' }}></i>
                      <i className="bi bi-telegram" style={{ fontSize: '18px', color: '#888' }}></i>
                  </div>
              </div>
          </div>
      </div>
      ...
      {isMobileSearchOpen && (
        <div className="d-lg-none position-absolute start-0 w-100" style={{ top: '64px', zIndex: 1049, backgroundColor: solidDarkBg, padding: '12px 15px', borderBottom: `1px solid ${subtleBorder}` }}>
