                                                        ...
                                                        <tr>
                                                            ...
                                                            <tbody>
                                                                {currentOffers.length === 0 ? (
                                                                    ...
                                                                    {/* 2. تعديل خلية الأزرار لضبط المساحة */}
                                                                    <td className="align-middle" style={{ backgroundColor: rowBg, padding: '12px 0', borderBottom: '1px solid #2d2d2d', textAlign: 'right', width: '10%' }}>
