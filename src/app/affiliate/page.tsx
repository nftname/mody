...
export default function AffiliatePage() {
  ...
  return (
    <main style={{ backgroundColor: BG_DARK, minHeight: '100vh', paddingBottom: '80px', color: TEXT_PRIMARY, fontFamily: 'sans-serif' }}>
                        ...
                        <div className="d-flex align-items-center gap-3 w-100" style={{ minWidth: 0 }}>
                            ...
                            <div className="flex-grow-1" style={{ minWidth: 0 }}>
                                ...
                                <div className="d-flex align-items-center gap-2 mt-1">
                                    <code style={{ color: BRAND_GOLD, fontSize: '15px', background: 'transparent', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', display: 'block', width: '100%', lineHeight: '1.4' }}>
                                        {referralLink}
                                    </code>
                                </div>
                            </div>
                                ...
                                <div style={{ height: '260px', width: '100%', position: 'relative' }}>
                                    <ResponsiveContainer width="100%" height="100%">
                                        <PieChart>
                                            ...
                                            <Tooltip contentStyle={{ backgroundColor: PANEL_BG, border: `1px solid ${BORDER_COLOR}`, borderRadius: '8px' }} itemStyle={{ color: '#ffffff' }} labelStyle={{ color: '#ffffff' }} cursor={{ fill: 'transparent' }} />
        ...
        <style jsx>{`
            .glass-panel { background: ${PANEL_BG}; border: 1px solid ${BORDER_COLOR}; box-shadow: 0 4px 20px rgba(0,0,0,0.2); }
            .icon-circle { width: 40px; height: 40px; border-radius: 50%; background: rgba(252, 213, 53, 0.1); color: ${BRAND_GOLD}; display: flex; align-items: center; justify-content: center; font-size: 18px; }
            .btn-gold-outline { background: transparent; border: 1px solid ${BRAND_GOLD}; color: ${BRAND_GOLD}; padding: 10px 24px; border-radius: 6px; font-size: 12px; font-weight: 700; letter-spacing: 1px; transition: all 0.3s; }
            .btn-gold-outline:hover { background: ${BRAND_GOLD}; color: #000; box-shadow: 0 0 15px rgba(252, 213, 53, 0.3); }
            .claim-btn { padding: 8px 0; border-radius: 6px; font-size: 11px; font-weight: 700; letter-spacing: 1px; transition: all 0.3s; text-transform: uppercase; background: rgba(252, 213, 53, 0.05); border: 1px solid rgba(252, 213, 53, 0.3); color: ${BRAND_GOLD}; backdrop-filter: blur(4px); }
            .claim-btn.active { cursor: pointer; border-color: ${BRAND_GOLD}; box-shadow: 0 0 15px rgba(252, 213, 53, 0.1); }
            .claim-btn.active:hover { background: rgba(252, 213, 53, 0.15); box-shadow: 0 0 20px rgba(252, 213, 53, 0.25); }
            .claim-btn.disabled { background: rgba(255, 255, 255, 0.02); border: 1px solid #444; color: #666; cursor: not-allowed; box-shadow: none; }
            .stat-card { background: ${PANEL_BG}; border: 1px solid ${BORDER_COLOR}; border-radius: 12px; padding: 20px; position: relative; overflow: hidden; }
            ...
            .chart-panel { background: ${PANEL_BG}; border: 1px solid ${BORDER_COLOR}; border-radius: 12px; padding: 20px; }
