      ...
      <div className="container mt-0">
        ...
        <div className="row justify-content-center g-2 mobile-clean-stack"> 
            <LuxuryIngot 
                ...
                onProcessing={(s: string) => { setModalType('process'); setProcessStep(s); setShowModal(true); }}
                ...
                {!isConnected ? (
                    <div className="custom-connect-btn" style={{ width: '100%' }}>
                        <ConnectButton.Custom>
                            {({ openConnectModal }) => (
                                <button onClick={openConnectModal} className="btn-ingot" style={{ width: '100%', height: '50px', cursor: 'pointer' }}>{label}</button>
                            )}
                        </ConnectButton.Custom>
                    </div>
                ) : (
