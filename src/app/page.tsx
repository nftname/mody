...
const NGXWidget = dynamicImport(() => import('@/components/NGXWidget'), { ssr: false });
const NGXCapWidget = dynamicImport(() => import('@/components/NGXCapWidget'), { ssr: false });
const NGXVolumeWidget = dynamicImport(() => import('@/components/NGXVolumeWidget'), { ssr: false });
