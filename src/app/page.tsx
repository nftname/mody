    ...
    <main style={{ backgroundColor: '#0d1117', minHeight: '100vh', paddingBottom: '0px', fontFamily: '"Inter", "Segoe UI", sans-serif', overflowX: 'hidden' }}>
      ...
      <section className="d-block d-md-none pt-3 pb-2 px-3">
          <h1 className="fw-bold text-white h4 text-start m-0" style={{ letterSpacing: '-0.5px', lineHeight: '1.3' }}>
              NNM â€” The Global Market of <span style={{ color: '#FCD535' }}>Nexus Rare Digital Name NFTs.</span>
          </h1>
          <p style={{ 
              fontFamily: '"Inter", "Segoe UI", sans-serif', 
              fontSize: '13px', 
      ...
      <section className="container py-2 py-md-4">
          ...
          <div className="w-100 py-3 border-top border-bottom border-secondary position-relative" style={{ borderColor: '#333 !important', marginTop: '5rem', marginBottom: '50px', backgroundColor: '#050505', maskImage: 'linear-gradient(to right, transparent, black 10%, black 90%, transparent)' }}>
      ...
      <style jsx global>{`
        ...
        @keyframes scroll { 0% { transform: translateX(0); } 100% { transform: translateX(-50%); } } .marquee-track { animation: scroll 60s linear infinite; width: max-content; }
