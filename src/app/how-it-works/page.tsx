...
export default function HowItWorksPage() {
  return (
    <main className="how-page" style={{ backgroundColor: BG_DEEP, minHeight: '100vh', fontFamily: '"Inter", "Segoe UI", sans-serif', paddingBottom: '80px' }}>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-12">
            ...
            <section className="mb-5 ps-lg-3">
              ...
              <p style={{ lineHeight: '1.6', marginBottom: '14px', color: TEXT_BODY_COLOR }}>
                Most NFT marketplaces focus on price and volume. But Conviction Rank shows which digital names are truly backed by verified supporters. Each supporter signals real belief, creating a transparent layer of trust across the market. Conviction Rank reveals underlying community trust and highlights assets with lasting confidence.
             ...
             <section className="mb-5 ps-lg-3">
              ...
              <p style={{ lineHeight: '1.6', marginBottom: '14px', color: TEXT_BODY_COLOR }}>
                By claiming your unique name in the NNM Registry, you instantly gain lifetime membership in ChainFace — your personal blockchain identity visible to the world, complete with up to 300,000 Conviction points,five stars, and free verification.
              </p>
      ...
      {/* --- BRAND TICKER (Corrected: Added border-secondary + #333) --- */}
