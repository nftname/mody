        ...
        <div className="row justify-content-center">
          ...
          <div className="col-12 col-lg-11"> 
            ...
            <section className="mb-4 ps-lg-3">
              ...
              <p>NFT markets have lacked a clear way to measure this—until now.</p>
              <p>Most analyses rely solely on price and volume—both reactive, easily manipulated, and often misleading. Conviction Rank introduces a fundamentally different metric: <strong className="text-white">belief-backed positioning.</strong></p>
            </section>
            ...
            <section className="mb-4 ps-lg-3">
              ...
              <p>Conviction Rank measures how many verified NFT holders are willing to publicly support a specific digital name.</p>
              <p className="mb-2">Every supporter:</p>
              <ul>
              ...
              <p>No anonymous votes. No bots. No free clicks. Each act of conviction carries real weight because it comes from active, verified participants.</p>
            </section>
            ...
            <section className="mb-4 ps-lg-3">
              ...
              <p>Not because the platform says so, But because the market itself signals alignment.</p>
              <p>This is social proof without manipulation. Collective belief without coordination. Decentralized confidence.</p>
            </section>
            ...
            <section className="mb-4 ps-lg-3">
              ...
              <p>As the ecosystem grows, early supporters gain historical positioning, not just economic benefit.</p>
