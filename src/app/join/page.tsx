...
const TASKS: Task[] = [
    { id: 'tw_rt', platform: 'X', label: 'Repost @nnmmarket on X', points: 10, type: 'daily', color: '#000000', icon: 'fa-brands fa-x-twitter', actionUrl: 'https://x.com/nnmmarket', instruction: 'Repost our pinned post, then paste the link to your repost below.', subText: 'daily', tooltip: 'You can complete this action once a day to earn points.' },
    { id: 'tw_like', platform: 'X', label: 'Like & Reply on X', points: 10, type: 'daily', color: '#000000', icon: 'fa-brands fa-x-twitter', actionUrl: 'https://x.com/nnmmarket', instruction: 'Like the pinned post and confirm your username below.', subText: 'daily', tooltip: 'You can complete this action once a day to earn points.' },
    { id: 'tg_like', platform: 'Telegram', label: 'Like & Reply on Telegram', points: 10, type: 'daily', color: '#229ED9', icon: 'fa-brands fa-telegram', actionUrl: 'https://t.me/NFTNNM', instruction: 'Interact with our latest post and enter your Telegram username below.', subText: 'daily', tooltip: 'You can complete this action once a day to earn points.' },
    { id: 'fb_like', platform: 'Facebook', label: 'Like & Reply on Facebook', points: 10, type: 'daily', color: '#1877F2', icon: 'fa-brands fa-facebook', actionUrl: 'https://www.facebook.com/profile.php?id=61586895007931', instruction: 'Interact with our latest post and enter your profile name below.', subText: 'daily', tooltip: 'You can complete this action once a day to earn points.' },
    { id: 'ig_like', platform: 'Instagram', label: 'Like & Reply on Instagram', points: 10, type: 'daily', color: '#E4405F', icon: 'fa-brands fa-instagram', actionUrl: 'https://www.instagram.com/NNM_Assets', instruction: 'Interact with our latest post and enter your IG handle below.', subText: 'daily', tooltip: 'You can complete this action once a day to earn points.' },
    { id: 'md_like', platform: 'Medium', label: 'Like & Reply on Medium', points: 10, type: 'daily', color: '#000000', icon: 'fa-brands fa-medium', actionUrl: 'https://medium.com/@nftnnmmarket', instruction: 'Interact with our latest article and enter your profile link below.', subText: 'daily', tooltip: 'You can complete this action once a day to earn points.' },
    { id: 'tw_follow', platform: 'X', label: 'Follow @nnmmarket on X', points: 30, type: 'once', color: '#000000', icon: 'fa-brands fa-x-twitter', actionUrl: 'https://x.com/nnmmarket', instruction: 'Click the link to follow us, then enter your X handle below.', subText: 'once', tooltip: 'This reward is one-time only and cannot be repeated. It is a core requirement to boost your rank.' },
    { id: 'tg_join', platform: 'Telegram', label: 'Join NFTNNM on Telegram', points: 30, type: 'once', color: '#229ED9', icon: 'fa-brands fa-telegram', actionUrl: 'https://t.me/NFTNNM', instruction: 'Join our channel and enter your Telegram username (@username) below.', subText: 'once', tooltip: 'This reward is one-time only and cannot be repeated. It is a core requirement to boost your rank.' },
    { id: 'fb_follow', platform: 'Facebook', label: 'Follow us on Facebook', points: 30, type: 'once', color: '#1877F2', icon: 'fa-brands fa-facebook', actionUrl: 'https://www.facebook.com/profile.php?id=61586895007931', instruction: 'Follow our page and enter your profile name below.', subText: 'once', tooltip: 'This reward is one-time only and cannot be repeated. It is a core requirement to boost your rank.' },
    { id: 'ig_follow', platform: 'Instagram', label: 'Follow us on Instagram', points: 30, type: 'once', color: '#E4405F', icon: 'fa-brands fa-instagram', actionUrl: 'https://www.instagram.com/NNM_Assets', instruction: 'Follow our official account and enter your IG handle below.', subText: 'once', tooltip: 'This reward is one-time only and cannot be repeated. It is a core requirement to boost your rank.' },
    { id: 'md_follow', platform: 'Medium', label: 'Follow us on Medium ', points: 30, type: 'once', color: '#000000', icon: 'fa-brands fa-medium', actionUrl: 'https://medium.com/@nftnnmmarket', instruction: 'Follow us on Medium and enter your profile link below.', subText: 'once', tooltip: 'This reward is one-time only and cannot be repeated. It is a core requirement to boost your rank.' }
];
