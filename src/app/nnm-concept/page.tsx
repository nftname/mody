      ...
      if (ctx) {
        ...
        chartInstance.current = new ChartConstructor(ctx, {
          ...
          options: {
            ...
            scales: {
              x: { 
                ticks: { color: TEXT_BODY_COLOR, font: { size: 10 } }, 
  ...
  return (
    <main className="concept-page" style={{ 
      ...
      flexDirection: 'column'
        ...
        /* Ingot Button Style */
        .btn-ingot {
          background: linear-gradient(180deg, ${GOLD_LIGHT} 0%, ${GOLD_BASE} 45%, ${GOLD_DARK} 100%);
          border: 1px solid ${GOLD_DARK};
          color: #2b1d00;
          font-family: 'Cinzel', serif;
          font-weight: 700;
          letter-spacing: 1px;
          box-shadow: 0 4px 10px rgba(0,0,0,0.35), 0 0 15px rgba(240, 196, 32, 0.18);
        ...
        /* Ticker Animations */
        .brand-text-gold { background: linear-gradient(to bottom, ${GOLD_LIGHT} 0%, ${GOLD_DARK} 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; text-shadow: 0 0 15px rgba(240, 196, 32, 0.2); } 
      ...
      {/* --- BRAND TICKER --- */}
        <div className="w-100 py-3 border-top border-bottom border-secondary position-relative" style={{ borderColor: '#2E2E2E', marginTop: 'auto', marginBottom: '20px', backgroundColor: '#1E1E1E', maskImage: 'linear-gradient(to right, transparent 0%, black 5%, black 95%, transparent 100%)', WebkitMaskImage: 'linear-gradient(to right, transparent 0%, black 5%, black 95%, transparent 100%)' }}>
          <div className="text-center mb-2"><span className="text-secondary text-uppercase" style={{ fontSize: '10px', letterSpacing: '3px', opacity: 1, color: TEXT_BODY_COLOR }}>Built for Web3</span></div>
